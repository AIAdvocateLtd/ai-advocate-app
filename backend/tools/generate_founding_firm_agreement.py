...
def build(firm_name="[FIRM NAME]",
    ...
    benefits = [
        ...
        "<b>Enhanced revenue-share on direct referrals</b> — when an AI Advocate user instructs the Firm via the platform and the Firm receives a fee from that user, the Firm retains <b>70%</b> of the fee and remits <b>30%</b> to AI Advocate as referral commission. This Founding Firm split is locked for the lifetime of the Firm's continuous subscription. AI Advocate's standard (non-Founding) referral commission rate shall not exceed <b>35%</b> for a minimum of 24 months from public launch.",
