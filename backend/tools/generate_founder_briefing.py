...
def build():
    ...
    auto_rows = [
        ...
        ["Jurisdiction switching", "⚠️ Semi-auto",
         "Lex switches if the user MENTIONS another country. We don't auto-switch on GPS detection — that's P2 enhancement."],
        ["IP geo-detection (security alerts)", "✅ Auto",
         "We alert on login from new country. Powers our security feature only."],
        ...
        ["Founding firm £199 lock-in", "⚠️ Manual",
         "Honoured by keeping the £199 Stripe price ID alive forever + a signed agreement on file. Code doesn't auto-grandfather."],
        ["5 fee-earner seats per firm (Practice tier)", "❌ Not built",
         "Currently 1 login per firm. P1 build (~1 day). For now, share login or hold deliverable until built."],
        ["Region-wide vs postcode listing", "⚠️ Marketing only",
         "All featured firms appear in directory. The 'wider' radius is a sales differentiator, not code-enforced. P1 build."],
        ["Custom firm branding in client flows", "❌ Not built",
         "P1 build (~half day). Would render firm's logo + colour in engagement chats. Honest answer: 'On the Q1 roadmap.'"],
